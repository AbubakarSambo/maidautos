...
export const stopsApi = {
  ...
  findActive: () => apiClient.get('/stops/active').then((r) => r.data.data),
  findDestinationsFrom: (from: string) => apiClient.get('/stops/destinations', { params: { from } }).then((r) => r.data.data),
