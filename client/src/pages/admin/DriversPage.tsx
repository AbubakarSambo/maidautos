    ...
    <div className="space-y-4">
      ...
      {isLoading ? (
        ...
        <div className="space-y-2">
          {drivers.map((driver) => (
            <div key={driver.id} className={`bg-white rounded-2xl border border-gray-100 shadow-sm p-4 flex items-center gap-4 ${!driver.isActive ? 'opacity-50' : ''}`}>
              ...
              <div className="flex items-center gap-2">
                <span className={`text-xs px-2.5 py-1 rounded-full font-semibold ${STATUS_COLORS[driver.status]}`}>{driver.status}</span>
